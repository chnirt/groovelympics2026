  ...
  ? [
      {
        ...
        format_vi: "Cá nhân",
        format_detailed:
          "Expected Athletes: 16 people\n\na. Group Stage: 4 groups, Round Robin, BO3 matches. 20x20 grid, 5 in a row wins. 10 mins per player.\n\nb. Quarter-finals: 8 athletes, Single Elimination, BO3.\n\nc. Semi-finals & Finals: BO3 semi-finals, BO5 finals. Bronze for losers of semis.",
        format_detailed_vi:
          "- Số lượng VĐV dự kiến: 16 người\n\na. Thể thức thi đấu – Vòng Bảng:\n- Bốc thăm ngẫu nhiên chia các VĐV thành 4 bảng đấu. Các VĐV sẽ thi đấu vòng tròn 1 lượt tính điểm theo thể thức BO3. Các VĐV sẽ thi đấu trên bàn cờ 20 x 20 ô, người có 5 quân liên tiếp trên 1 hàng trước & có hở ít nhất 1 đầu sẽ là người thắng.\n- Áp dụng luật kiểm soát thời gian & đồng hồ bấm giờ, mỗi VĐV có 10 phút/ván, nếu VĐV dùng hết 10 phút trước mà chưa phân thắng bại, người đó bị xử thua ván đó.\n- Cách tính điểm sau mỗi trận đấu:\n+ Ván thắng: 01 điểm\n+ Ván thua: 00 điểm\n- Sau Vòng Bảng, tính tổng điểm của các VĐV để xếp hạng, 2 VĐV đứng đầu mỗi bảng sẽ bước vào Vòng Loại trực tiếp.\n- Trường hợp có các VĐV bằng điểm & không thể quyết định thứ hạng, các VĐV này sẽ thi đấu tiebreak 1 trận để xác định thứ hạng.\n\nb. Thể thức thi đấu – Vòng Tứ kết:\n- 08 VĐV sẽ được bốc thăm để xác định các cặp đấu của Vòng Tứ kết. Các VĐV sẽ thi đấu để tìm ra 04 VĐV bước vào Vòng Bán kết theo thể thức BO3. Các VĐV sẽ thi đấu trên bàn cờ 20 x 20 ô, người có 5 quân liên tiếp trên 1 hàng trước & có hở ít nhất 1 đầu sẽ là người thắng.\n- Áp dụng luật kiểm soát thời gian & đồng hồ bấm giờ, mỗi VĐV có 10 phút/ván, nếu VĐV dùng hết 10 phút trước mà chưa phân thắng bại, người đó bị xử thua ván đó.\n \nc. Thể thức thi đấu – Vòng Bán kết & Chung kết:\n- 04 VĐV sẽ được bốc thăm để xác định các cặp đấu của Vòng Bán kết theo thể thức BO3. Các VĐV sẽ thi đấu để tìm ra 02 VĐV bước vào Vòng Chung kết, 02 VĐV còn lại sẽ nhận huy chương đồng. \n- Trận Chung kết sẽ diễn ra theo thể thức BO5.\n- Các VĐV sẽ thi đấu trên bàn cờ 20 x 20 ô, người có 5 quân liên tiếp trên 1 hàng trước & có hở ít nhất 1 đầu sẽ là người thắng.\n- Áp dụng luật kiểm soát thời gian & đồng hồ bấm giờ, mỗi VĐV có 10 phút/ván, nếu VĐV dùng hết 10 phút trước mà chưa phân thắng bại, người đó bị xử thua ván đó.",
        description:
        ...
        description_vi:
          'Trò chơi trí tuệ đỉnh cao!\nCuộc chiến của trí tuệ và tầm nhìn. Thi đấu trên bàn cờ 20x20 với mục tiêu đơn giản nhưng đầy thử thách: xếp 5 quân cờ liên tiếp để giành chiến thắng. Với đồng hồ 10 phút mỗi bên và đấu BO3, mỗi nước đi đều quan trọng. Hãy tập trung và hô vang "Caro!"',
        rules: "Group Stage\nKnock-out Stage",
        rules_vi: "Vòng bảng\nVòng loại",
        regulations:
          "- Board Size: Exactly 20x20. Moves outside are invalid.\n- First Move: Rock-paper-scissors in Game 1. Loser of previous game starts next.\n- Electronics: No smartphones or AI apps allowed.",
        regulations_vi:
          "- Kích thước bàn cờ: Các trận đấu diễn ra trên bàn cờ giới hạn đúng 20x20 ô. Bất kỳ nước cờ nào đánh ra ngoài viền khu vực này đều được tính là nước đi không hợp lệ.\n- Lượt đi đầu tiên: Ở ván 1, hai Vận động viên (VĐV) sẽ oẳn tù tì để giành quyền đi trước (chơi quân X). Ở các ván tiếp theo, người thua ở ván trước sẽ được quyền chọn đi trước hoặc sau. \n- Thiết bị điện tử: VĐV không được phép sử dụng điện thoại thông minh hoặc mở các ứng dụng giải cờ (AI/Bot) trong suốt quá trình ngồi tại bàn thi đấu",
        icon: "Trophy",
      },
      {
        id: 2,
...
export const ATHLETES: Athlete[] = import.meta.env.DEV
  ? [
      {
        id: "1",
        name: "Nguyen Van A",
        country: "Vietnam",
        sportIds: [1],
        image: "https://picsum.photos/seed/nva/200/200",
      },
      {
        id: "2",
        name: "John Doe",
        country: "USA",
        sportIds: [9],
        image: "https://picsum.photos/seed/jdoe/200/200",
      },
      {
        id: "3",
        name: "Lee Min Ho",
        country: "Korea",
        sportIds: [5],
        image: "https://picsum.photos/seed/lmh/200/200",
      },
      { id: "4", name: "Tran Thi B", country: "Vietnam", sportIds: [7] },
      { id: "5", name: "Alex Turner", country: "UK", sportIds: [3] },
      {
        id: "6",
        name: "Hiroshi Sato",
        country: "Japan",
        sportIds: [2],
        image: "https://picsum.photos/seed/hs/200/200",
      },
      { id: "7", name: "Zhang Wei", country: "China", sportIds: [8] },
      {
        id: "8",
        name: "Maria Garcia",
        country: "Spain",
        sportIds: [4],
        image: "https://picsum.photos/seed/mg/200/200",
      },
    ]
  : [];

export const MATCHES: Match[] = import.meta.env.DEV
  ? [
      // Chess - Caro (ID 1)
      {
        id: "m-1",
      ...
      },
      {
        ...
        scoreB: "-",
        status: "upcoming",
        timestamp: "2026-07-16T18:30:00",
        stage: "FC 26 - Vòng Chung Kết",
      },
      ...
      },
      {
        ...
        stage: "Liên Quân - Vòng Chung Kết",
      },
      ...
      },
      {
        ...
        stage: "Mario Kart - Vòng Chung Kết",
      },
      ...
      },
      {
        ...
        stage: "Pool 9 Bi - Vòng Chung Kết",
      },
      ...
      },
      {
        ...
        stage: "Bóng Đá - Vòng Chung Kết",
      },
    ]
  : [];

export const MEDALS: CountryMedal[] = import.meta.env.DEV
  ? [
